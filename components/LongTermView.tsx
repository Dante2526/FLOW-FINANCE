...
const LongTermView: React.FC<Props> = ({ items, onAdd, onEdit, onDelete, appLanguage, isPro = false }) => {
  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-300">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-[11.5rem]">
        {items.length === 0 ? (
      ...
      <button 
        ...
        className="fixed bottom-28 right-6 w-14 h-14 bg-accent rounded-full flex items-center justify-center shadow-2xl hover:bg-accentDark transition-colors z-[60]"
      >
