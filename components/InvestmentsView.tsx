...
const InvestmentsView: React.FC<Props> = ({ investments, onAdd, onEdit, onDelete, onBack, cdiRate, onUpdateCdiRate, isPro = false, onOpenProModal, appLanguage }) => {
  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-300">
      ...
      <div className="flex-1 flex flex-col gap-2 pb-[11.5rem]" data-tour-id="investments-list">
      ...
      <button onClick={() => { setEditingInvestment(null); setIsAddModalOpen(true); }} className="fixed bottom-32 right-6 w-14 h-14 bg-accent rounded-full flex items-center justify-center shadow-2xl hover:bg-accentDark transition-colors z-[60] active:scale-90" data-tour-id="investments-add-button"><Plus className="w-6 h-6 text-black" /></button>
