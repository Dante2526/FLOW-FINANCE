               ...
               <div className="flex justify-between items-center p-5 shrink-0 bg-[#1c1c1e] z-20 border-b border-white/5 shadow-sm">
                  ...
                  <div className="flex gap-2">
                     <button
                        ...
                        className={`h-10 rounded-full flex items-center justify-center transition-all ${showClearConfirm
               ...
               <div className="p-4 shrink-0 bg-[#1c1c1e] border-t border-white/5 flex flex-col gap-3 z-20 shadow-[0_-5px_15px_rgba(0,0,0,0.3)]">
                  ...
                  <div className="flex bg-[#2c2c2e] p-1.5 rounded-2xl gap-2">
                     <button
                        ...
                        className={`flex-1 h-12 rounded-xl flex items-center justify-center gap-2 transition-all ${activeTool === 'cursor'
                     ...
                     <button
                        ...
                        className={`flex-1 h-12 rounded-xl flex items-center justify-center gap-2 transition-all ${activeTool === 'pen'
                     ...
                     <button
                        ...
                        className={`w-14 h-12 rounded-xl flex items-center justify-center transition-all ${activeTool === 'eraser'
...
export default React.memo(NotepadModal);
