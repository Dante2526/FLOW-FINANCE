    ...
    settings: {
      ...
      privacyContent: {
        ...
        sections: [
           ...
           { title: "2. Almacenamiento y Seguridad", text: "Sus datos se almacenan de forma segura utilizando servicios en la nube encriptados (Supabase/Firebase). La aplicación también utiliza el almacenamiento local de su dispositivo para garantizar el funcionamiento sin conexión y mejorar el rendimiento. No compartimos sus datos financieros con terceros." },
