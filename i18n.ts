...
export const TRANSLATIONS = {
  pt: {
    ...
    notifications: {
      ...
      activeStatus: "Notificações ativas",
      revokeBtn: "Desativar Alertas",
    ...
    settings: {
      ...
      autoCreateMonthTitle: "Criar Mês Automaticamente",
      autoCreateMonthDesc: "O sistema cria o próximo mês sozinho, copiando as contas para poupar seu tempo.",
      autoCreateMonthHelp: "Toda vez que você abrir o app num novo mês, o sistema irá criar e carregar suas contas automáticas do mês anterior para que você não precise fazer isso manualmente. É o seu assistente de controle mensal!",
      autoMonthCreatedToast: "💳 Mês Criado Automaticamente!",
      autoMonthCreatedExplain: "Um novo Mês foi criado para as novas despesas.",
  ...
  en: {
    ...
    notifications: {
      ...
      activeStatus: "Notifications active",
      revokeBtn: "Disable Alerts",
    ...
    settings: {
      ...
      autoCreateMonthTitle: "Create Month Automatically",
      autoCreateMonthDesc: "The system creates the next month alone, copying accounts to save your time.",
      autoCreateMonthHelp: "Every time you open the app in a new month, the system will create and load your monthly accounts from the previous month automatically so you don't have to do it manually. It's your monthly control assistant!",
      autoMonthCreatedToast: "💳 Month Created Automatically!",
      autoMonthCreatedExplain: "A new Month has been created for your new expenses.",
      ...
      privacyContent: {
        ...
        sections: [
           ...
           { title: "2. Storage and Security", text: "Your data is securely stored using encrypted cloud services (Supabase). The app also uses your device's local storage to ensure offline functionality and improve performance. We do not share your financial data with third parties." },
  ...
  es: {
    ...
    settings: {
      ...
      autoCreateMonthTitle: "Crear Mes Automáticamente",
      autoCreateMonthDesc: "El sistema crea el próximo mes solo, copiando cuentas para ahorrar tiempo.",
      autoCreateMonthHelp: "Cada vez que abra la aplicación en un nuevo mes, el sistema creará y cargará sus cuentas mensuales del mes anterior automáticamente para que não tenha que fazê-lo manualmente. ¡Es su asistente de control mensual!",
      autoMonthCreatedToast: "💳 ¡Mes Creado Automáticamente!",
      autoMonthCreatedExplain: "Se ha creado un nuevo Mes para los nuevos gastos.",
