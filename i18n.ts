  ...
  es: {
    ...
    settings: {
      ...
      privacyContent: {
        ...
        sections: [
           { title: "1. Recopilación de Datos", text: "Flow Finance solo recopila la información estrictamente necesaria para el funcionamiento de la aplicación, como su dirección de correo electrónico (para autenticación) y los datos financieros ingresados manualmente por usted (transacciones, cuentas e inversiones)." },
