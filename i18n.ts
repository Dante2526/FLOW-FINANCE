...
export const TRANSLATIONS = {
  pt: {
    ...
    auth: {
      ...
      loginSub: 'Enviaremos um link de acesso para seu e-mail.',
      registerSub: 'Comece a controlar seu dinheiro hoje.',
      namePlaceholder: 'Seu Nome',
      emailPlaceholder: 'seu@email.com',
      btnEnter: 'Enviar Link Mágico',
      btnCreate: 'Criar e Enviar Link',
      haveAccount: 'Já possui conta? Fazer Login',
      noAccount: 'Não tem uma conta? Cadastre-se',
      magicLinkTitle: 'Verifique seu E-mail',
      magicLinkSub: 'Enviamos um link de acesso para {email}. Clique nele para entrar.',
      spamWarning: 'Verifique a caixa de Spam',
      security: 'ACESSO SEM SENHA',
      back: 'Voltar',
      copyright: "© 2026 Flow Finance",
      errors: {
        invalidEmail: 'Por favor, insira um e-mail válido.',
        missingName: 'Por favor, informe seu nome.',
        genericSend: "Erro ao enviar o link. Tente novamente."
      }
    },
    donationModal: {
      title: "Apoiar",
  ...
  en: {
    ...
    auth: {
      ...
      loginSub: "We'll send a magic link to your email.",
      registerSub: 'Start controlling your money today.',
      namePlaceholder: 'Your Name',
      emailPlaceholder: 'your@email.com',
      btnEnter: 'Send Magic Link',
      btnCreate: 'Create & Send Link',
      haveAccount: 'Already have an account? Log In',
      noAccount: "Don't have an account? Sign Up",
      magicLinkTitle: 'Check your Email',
      magicLinkSub: "We've sent an access link to {email}. Click it to log in.",
      spamWarning: 'Check your Spam folder',
      security: 'PASSWORDLESS LOGIN',
      back: 'Back',
      copyright: "© 2026 Flow Finance",
      errors: {
        invalidEmail: 'Please enter a valid email.',
        missingName: 'Please enter your name.',
        genericSend: "Error sending link. Please try again."
      }
    },
    proModal: {
  ...
  es: {
    ...
    auth: {
      ...
      loginSub: 'Enviaremos un enlace de acceso a tu correo.',
      registerSub: 'Empieza a controlar tu dinero hoy.',
      namePlaceholder: 'Tu Nombre',
      emailPlaceholder: 'tu@email.com',
      btnEnter: 'Enviar Enlace Mágico',
      btnCreate: 'Crear y Enviar Enlace',
      haveAccount: '¿Ya tienes cuenta? Iniciar Sesión',
      noAccount: '¿No tienes cuenta? Regístrate',
      magicLinkTitle: 'Verifica tu Correo',
      magicLinkSub: 'Hemos enviado un enlace de acceso a {email}. Haz clic para entrar.',
      spamWarning: 'Revisa tu carpeta de Spam',
      security: 'ACCESO SIN CONTRASEÑA',
      back: 'Volver',
      copyright: "© 2026 Flow Finance",
      errors: {
        invalidEmail: 'Por favor, ingresa un correo válido.',
        missingName: 'Por favor, ingresa tu nombre.',
        genericSend: "Error al enviar el enlace. Inténtalo de nuevo."
      }
    },
    proModal: {
